#!/usr/bin/env python3
"""
Generate static HTML pages for each country - V2 with full SEO optimization
Includes:
...
4. Rich Schema.org markup (PostalCode, Place, ItemList)
...
def generate_static_page_v2(country_id, country_data):
    """Generate an optimized static HTML page for a country"""
    ...
    # Combine all schemas
    all_schemas = [schema_webpage, schema_itemlist, schema_org] + schema_postalcodes[:5]
      ...
      <div class="top-section">
        ...
        <section class="search-tool" aria-labelledby="search-heading">
          <div class="search-tool-header">
            <img id="search-country-flag" class="search-country-flag" src="flags/{flag_code}.png" alt="{display_name} flag" width="24" height="18" loading="eager">
...
def main():
    ...
    print("Starting optimized static page generation (V2)...")
    ...
    for country in countries:
        ...
        slug, html = generate_static_page_v2(country_id, country_data)
    ...
    print(f"\nGenerated {len(generated_pages)} optimized static pages successfully!")
